...
contract NFTBoosterAuctionsTest is Test {
    ...
    function testMemberCantAddAunction() public {
        ...
        s_nftBoosterAuctions.addAuction(
            "fake description", "fake symbol", "fake _name", 10000000000, 1000000000, s_tmpImageUris
        );
    }
    ...
    function testCantBidOnClosedBid() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(NFTBoosterAuctions.NFTBoosterAuctions__BidNotOpenYet.selector, 0));
